...
/*
 Ao inves do metodo ficar assim, e no atualizar colocarmos o mesmo código
 criamos o metodo salvarClienteComCep pra usar ele das duas opções
	@Override
	public void inserir(Cliente cliente) {
	//Verificar se o endereço do cliente já existe (pelo CEP)
		String cep = cliente.getEndereco().getCep();
		Endereco endereco = enderecoRepository.findAllById(cel).orElseGet() -> {
